...
def prepare_juice():
    ...
    if question == "SIM":
        prepare_drink()
         ...
         print("Finalizando ABS - Sistema automatizado de bebidas do McDonalds.")
...
def prepare_soda():
     ...
     if question ==  "SIM":
        ...
        print("Finalizando ABS - Sistema automatizado de bebidas do Mac Donalds")
     

def prepare_drink():
    print("Bem vindo ao BNS - Sistema automatizado de bebidas do McDonalds.")
